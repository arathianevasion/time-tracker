...
- **"That saved login isn't working anymore"** — your API token expired (they last about a year) or was revoked. Just make a new one following step 3 above; the app will ask for it automatically.
